...
from authentication.DecisionTreeClassifier import * # noqa
...
class RandomForest():
    ...
    def bagging_predict(self, trees, row):
        ...
        predictions = [DecisionTreeClassifier.predict(tree, row) for tree in trees] # noqa
    ...
    def random_forest(self, train, test):
        ...
        for i in range(self.n_trees):
            DT = DecisionTreeClassifier(self.max_depth, self.min_size) # noqa
